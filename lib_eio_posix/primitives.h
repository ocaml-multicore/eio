...
CAMLprim value caml_eio_posix_makedev(value, value);
CAMLprim value caml_eio_posix_dev_major(value);
CAMLprim value caml_eio_posix_dev_minor(value);
CAMLprim value caml_eio_posix_mknodat(value, value, value, value);
